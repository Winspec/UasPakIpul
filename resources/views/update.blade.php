...
<div class="border border-blue-200 shadow-md p-4 rounded-md bg-white w-[800px] h-[400]">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                ...
                <td class="border px-4 py-2 text-center">
                    <a href="/edit/{{ $r->id }}"><button class="px-4 py-1 border border-gray-400 rounded hover:bg-blue-200">edit</button></a>
                </td>
            </tr>
             @endforeach
        </tbody>
    ...
    <div class="flex justify-start gap-2 mt-4 bg-gray-100 p-2 rounded">
      ...
      <button class="px-4 py-1 border border-gray-400 rounded hover:bg-blue-200">Update</button>
